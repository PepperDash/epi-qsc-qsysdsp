...
namespace PepperDash.Essentials.Plugins.Qsc.Qsys.ExternalControlProtocol
{
    ...
    /// ! "myLevelName" -77
    /// </remarks>
    public class QsysEcpController : ReconfigurableDevice, IDspPresets, IBridgeAdvanced, IOnline, ICommunicationMonitor
    {
        /// <summary>
        ...
        public List<QsysPresets> PresetList = new List<QsysPresets>();
